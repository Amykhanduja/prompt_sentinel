...
interface DuplicatePenaltiesChartProps {
  data: RiskPolicyData['duplicatePenaltiesOverTime'] | null;
  loading: boolean;
}

export const DuplicatePenaltiesChart: React.FC<DuplicatePenaltiesChartProps> = ({ data, loading }) => {
  const hasData = data && data.length > 0;

  return (
    <div className="glass-panel p-5 h-[300px] flex flex-col">
      <h3 className="text-sm font-semibold mb-4 text-white uppercase tracking-wider">Duplicate Penalties Applied</h3>
